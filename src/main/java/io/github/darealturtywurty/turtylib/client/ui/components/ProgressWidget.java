...
public class ProgressWidget extends AbstractWidget {
    ...
    private final Supplier<Integer> progressSupplier, maxProgressSupplier;

    private int progress, maxProgress;
    private int frame;

    public ProgressWidget(int pX, int pY, int pWidth, int pHeight, int frames, ResourceLocation texture, int textureX, int textureY, int fillX, int fillY, int fillWidth, int fillHeight, int fillColor, Supplier<Integer> progressSupplier, Supplier<Integer> maxProgressSupplier) {
    ...
    public void render(PoseStack pPoseStack, int pMouseX, int pMouseY, float pPartialTick) {
        ...
        this.progress = this.progressSupplier.get();
        this.maxProgress = this.maxProgressSupplier.get();
