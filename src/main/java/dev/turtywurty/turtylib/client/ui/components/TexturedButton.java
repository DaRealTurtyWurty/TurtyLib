...
public class TexturedButton extends Button {
    ...
    public TexturedButton(ResourceLocation texture, int xPos, int yPos, int width, int height, int texX, int texY,
        int texWidth, int texHeight, float alpha, OnPress pressable, OnTooltip tooltip) {
        this(texture, xPos, yPos, width, height, texX, texY, texWidth, texHeight, btn -> alpha, pressable, tooltip);
    }

    public TexturedButton(ResourceLocation texture, int xPos, int yPos, int width, int height, int texX, int texY,
        int texWidth, int texHeight, Object2FloatFunction<TexturedButton> alpha, OnPress pressable, OnTooltip tooltip) {
