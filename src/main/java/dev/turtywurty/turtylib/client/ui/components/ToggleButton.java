...
public class ToggleButton extends AbstractWidget {
    ...
    public void initTextureValues(int xTexStart, int yTexStart, int xDiffTex, int yDiffTex, ResourceLocation textureLoc) {
    ...
    public void renderWidget(PoseStack stack, int mouseX, int mouseY, float partialTicks) {
        ...
        this.isHovered = MathUtils.isWithinArea(mouseX, mouseY, getX(), getY(), this.width, this.height);

        if (!this.label.getString().isBlank()) {
            this.font.draw(stack, this.label, this.baseXPos, getY() + this.height / 4f, 0x404040);
            setX(this.baseXPos + this.font.width(this.label));
        }
        ...
        blit(stack, getX(), getY(), xPos, yPos, this.width, this.height, 32, 32);
